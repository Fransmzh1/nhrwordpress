...
add_action( 'admin_menu', 'donasi_page' );

function donasi_page() {
	// add_menu_page( $page_title, $menu_title, $capability, $menu_slug, $function, $icon_url, $position );
	add_menu_page( 
    	'Ingin ber-Donasi?', 
		'<span class="donasi">Ingin Donasi?</span>', 
		'manage_options', 
		'donasi', 
		'berdonasi', 
		'dashicons-heart', 
...
function berdonasi() {
	...
	<div class="wmin__wrapper">
    	<div class="logo__wm"><img src="<?php echo get_theme_file_uri('wm-img/webmasjid.png'); ?>" /></div>
		<div class="div__clear">
		    <div class="donasi__dev">
				<div class="div__clear">
					<div class="inner__logo">
					    Suka dengan tema WP Masjid dari Ciuss Creative?. Ingin ber-Donasi kepada developer pengembangnya? Silahkan bisa disalurkan melalui akun wallet dibawah ini.
					</div>
					<br/><br/>
				</div>
			    <div class="logo__dev">
				    <div class="inner__logo">
			        	<img src="<?php echo get_theme_file_uri('wm-img/dana.jpg'); ?>" />
						0815-3274-4804
					</div>
				</div>
				<div class="logo__dev">
				    <div class="inner__logo">
			        	<img src="<?php echo get_theme_file_uri('wm-img/ovo.jpg'); ?>" />
						0815-3274-4804
					</div>
				</div>
				<div class="logo__dev">
				    <div class="inner__logo">
			        	<img src="<?php echo get_theme_file_uri('wm-img/linkaja.jpg'); ?>" />
						0815-3274-4804
					</div>
				</div>
				<div class="logo__dev">
