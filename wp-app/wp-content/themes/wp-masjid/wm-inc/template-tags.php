...
if ( ! function_exists( 'text_footer' ) ) :
	function text_footer() {
		echo 'WP Masjid dibuat oleh developer <a href="' . esc_url('https://ciuss.com') . '">tema wordpress</a> Ciuss Creative. Menggunakan CMS <a href="' . esc_url('https://wordpress.org') . '">WordPress</a>';
	}
endif;
